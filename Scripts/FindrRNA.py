...
dir = "/home/junyuchen/Lab/Probe-Match/Root-WGS-Annotated/"
        ...
        if len(record.features) != 0:
            for i in range(len(record.features)):
                ...
                if '23S ribosomal RNA' in record.features[i].qualifiers["product"][0]:
                    ...
                    SeqIO.write(seq_23S, "/home/junyuchen/Lab/Probe-Match/Root-rRNA2/"+tempFile[:-4]+"_23S_rRNA.fasta", "fasta")
                    ...
                    SeqIO.write(seq_16S, "/home/junyuchen/Lab/Probe-Match/Root-rRNA2/"+tempFile[:-4]+"_16S_rRNA.fasta", "fasta")
                    #print(seq_16S)
